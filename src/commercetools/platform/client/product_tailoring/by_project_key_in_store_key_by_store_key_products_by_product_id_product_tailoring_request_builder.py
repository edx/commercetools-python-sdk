...
from ..images.by_project_key_in_store_key_by_store_key_products_by_product_id_product_tailoring_images_request_builder import (
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/in-store/key={self._store_key}/products/{self._product_id}/product-tailoring",
