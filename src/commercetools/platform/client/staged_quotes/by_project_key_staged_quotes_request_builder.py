...
from ...models.staged_quote import (
    StagedQuote,
    StagedQuoteDraft,
    StagedQuotePagedQueryResponse,
)
from .by_project_key_staged_quotes_by_id_request_builder import (
    ByProjectKeyStagedQuotesByIDRequestBuilder,
)
from .by_project_key_staged_quotes_key_by_key_request_builder import (
...
class ByProjectKeyStagedQuotesRequestBuilder:
    ...
    def with_key(self, key: str) -> ByProjectKeyStagedQuotesKeyByKeyRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyStagedQuotesByIDRequestBuilder:
    ...
    def get(
        ...
        *,
    ...
    ) -> typing.Optional["StagedQuotePagedQueryResponse"]:
        params = {
            "expand": expand,
            "sort": sort,
            "limit": limit,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/staged-quotes",
            params=params,
            headers=headers,
            options=options,
        )
        if response.status_code == 200:
            return StagedQuotePagedQueryResponse.deserialize(response.json())
    ...
    def post(
        ...
        *,
        ...
        if response.status_code in (201, 200):
            return StagedQuote.deserialize(response.json())
        elif response.status_code in (400, 401, 403, 500, 502, 503):
            obj = ErrorResponse.deserialize(response.json())
            raise self._client._create_exception(obj, response)
        elif response.status_code == 404:
