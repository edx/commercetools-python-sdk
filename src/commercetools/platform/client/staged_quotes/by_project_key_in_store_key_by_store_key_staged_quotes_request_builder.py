...
from .by_project_key_in_store_key_by_store_key_staged_quotes_by_id_request_builder import (
    ByProjectKeyInStoreKeyByStoreKeyStagedQuotesByIDRequestBuilder,
)
from .by_project_key_in_store_key_by_store_key_staged_quotes_key_by_key_request_builder import (
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/in-store/key={self._store_key}/staged-quotes",
            params=params,
            headers=headers,
            options=options,
        )
