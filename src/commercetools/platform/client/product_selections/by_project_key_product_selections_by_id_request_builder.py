...
from ..products.by_project_key_product_selections_by_id_products_request_builder import (
    ByProjectKeyProductSelectionsByIDProductsRequestBuilder,
)
...
class ByProjectKeyProductSelectionsByIDRequestBuilder:
    ...
    def products(self) -> ByProjectKeyProductSelectionsByIDProductsRequestBuilder:
