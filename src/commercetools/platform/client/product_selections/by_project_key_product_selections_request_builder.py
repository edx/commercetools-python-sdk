...
from ...models.product_selection import (
    ProductSelection,
    ProductSelectionDraft,
    ProductSelectionPagedQueryResponse,
)
from .by_project_key_product_selections_by_id_request_builder import (
    ByProjectKeyProductSelectionsByIDRequestBuilder,
)
from .by_project_key_product_selections_key_by_key_request_builder import (
...
class ByProjectKeyProductSelectionsRequestBuilder:
    ...
    def with_key(self, key: str) -> ByProjectKeyProductSelectionsKeyByKeyRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyProductSelectionsByIDRequestBuilder:
    ...
    def get(
        ...
        *,
    ...
    ) -> typing.Optional["ProductSelectionPagedQueryResponse"]:
        params = {
            "expand": expand,
            "sort": sort,
            "limit": limit,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/product-selections",
            params=params,
            headers=headers,
            options=options,
        )
        if response.status_code == 200:
            return ProductSelectionPagedQueryResponse.deserialize(response.json())
    ...
    def post(
        ...
        *,
        ...
        if response.status_code in (201, 200):
            return ProductSelection.deserialize(response.json())
        elif response.status_code in (400, 401, 403, 500, 502, 503):
            obj = ErrorResponse.deserialize(response.json())
            raise self._client._create_exception(obj, response)
        elif response.status_code == 404:
