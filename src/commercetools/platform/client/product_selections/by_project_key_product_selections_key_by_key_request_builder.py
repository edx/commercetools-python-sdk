...
from ...models.product_selection import ProductSelection, ProductSelectionUpdate
from ..products.by_project_key_product_selections_key_by_key_products_request_builder import (
...
class ByProjectKeyProductSelectionsKeyByKeyRequestBuilder:
    ...
    def products(self) -> ByProjectKeyProductSelectionsKeyByKeyProductsRequestBuilder:
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/product-selections/key={self._key}",
