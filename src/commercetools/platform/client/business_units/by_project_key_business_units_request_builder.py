...
from .by_project_key_business_units_by_id_request_builder import (
    ByProjectKeyBusinessUnitsByIDRequestBuilder,
)
from .by_project_key_business_units_key_by_key_request_builder import (
...
class ByProjectKeyBusinessUnitsRequestBuilder:
    ...
    def with_key(self, key: str) -> ByProjectKeyBusinessUnitsKeyByKeyRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyBusinessUnitsByIDRequestBuilder:
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/business-units",
            params=params,
            headers=headers,
            options=options,
        )
