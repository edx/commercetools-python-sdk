...
from ...models.business_unit import BusinessUnit, BusinessUnitUpdate
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/as-associate/{self._associate_id}/business-units/key={self._key}",
