...
from .by_project_key_me_quotes_by_id_request_builder import (
    ByProjectKeyMeQuotesByIDRequestBuilder,
)
from .by_project_key_me_quotes_key_by_key_request_builder import (
...
class ByProjectKeyMeQuotesRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyMeQuotesByIDRequestBuilder:
    ...
    def with_key(self, key: str) -> ByProjectKeyMeQuotesKeyByKeyRequestBuilder:
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/me/quotes",
            params=params,
            headers=headers,
            options=options,
        )
