...
from ...models.quote import Quote, QuoteDraft, QuotePagedQueryResponse
from .by_project_key_quotes_by_id_request_builder import (
    ByProjectKeyQuotesByIDRequestBuilder,
)
from .by_project_key_quotes_key_by_key_request_builder import (
...
class ByProjectKeyQuotesRequestBuilder:
    ...
    def with_key(self, key: str) -> ByProjectKeyQuotesKeyByKeyRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyQuotesByIDRequestBuilder:
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/quotes",
            params=params,
            headers=headers,
            options=options,
        )
