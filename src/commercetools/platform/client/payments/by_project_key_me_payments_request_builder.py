...
class ByProjectKeyMePaymentsRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyMePaymentsByIDRequestBuilder:
    ...
    def get(
        ...
        *,
    ...
    ) -> typing.Optional["MyPaymentPagedQueryResponse"]:
        params = {
            "expand": expand,
            "sort": sort,
            "limit": limit,
        ...
        if response.status_code == 200:
            return MyPaymentPagedQueryResponse.deserialize(response.json())
