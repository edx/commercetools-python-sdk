...
from ...models.me import MyQuoteRequestDraft
from ...models.quote_request import QuoteRequest, QuoteRequestPagedQueryResponse
from .by_project_key_me_quote_requests_by_id_request_builder import (
    ByProjectKeyMeQuoteRequestsByIDRequestBuilder,
)
from .by_project_key_me_quote_requests_key_by_key_request_builder import (
...
class ByProjectKeyMeQuoteRequestsRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyMeQuoteRequestsByIDRequestBuilder:
    ...
    def with_key(self, key: str) -> ByProjectKeyMeQuoteRequestsKeyByKeyRequestBuilder:
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/me/quote-requests",
            params=params,
            headers=headers,
            options=options,
        )
