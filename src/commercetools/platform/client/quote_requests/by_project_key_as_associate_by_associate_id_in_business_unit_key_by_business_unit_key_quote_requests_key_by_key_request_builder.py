...
from ...models.quote_request import QuoteRequest, QuoteRequestUpdate
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/as-associate/{self._associate_id}/in-business-unit/key={self._business_unit_key}/quote-requests/key={self._key}",
