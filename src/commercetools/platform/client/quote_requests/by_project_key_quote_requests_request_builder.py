...
from .by_project_key_quote_requests_by_id_request_builder import (
    ByProjectKeyQuoteRequestsByIDRequestBuilder,
)
from .by_project_key_quote_requests_key_by_key_request_builder import (
...
class ByProjectKeyQuoteRequestsRequestBuilder:
    ...
    def with_key(self, key: str) -> ByProjectKeyQuoteRequestsKeyByKeyRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyQuoteRequestsByIDRequestBuilder:
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/quote-requests",
            params=params,
            headers=headers,
            options=options,
        )
