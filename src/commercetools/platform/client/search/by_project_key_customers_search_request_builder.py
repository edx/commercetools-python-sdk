...
from ...models.customer_search import CustomerPagedSearchResponse, CustomerSearchRequest
...
class ByProjectKeyCustomersSearchRequestBuilder:
    ...
    def post(
        ...
        *,
    ...
    ) -> typing.Optional["CustomerPagedSearchResponse"]:
        headers = {} if headers is None else headers
        response = self._client._post(
            endpoint=f"/{self._project_key}/customers/search",
            params={},
            json=body.serialize(),
        ...
        if response.status_code == 200:
            return CustomerPagedSearchResponse.deserialize(response.json())
