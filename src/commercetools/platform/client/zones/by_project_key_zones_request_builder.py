...
class ByProjectKeyZonesRequestBuilder:
    ...
    def with_key(self, key: str) -> ByProjectKeyZonesKeyByKeyRequestBuilder:
    ...
    def with_id(self, id: str) -> ByProjectKeyZonesByIDRequestBuilder:
    ...
    def get(
        ...
        *,
    ...
    ) -> typing.Optional["ZonePagedQueryResponse"]:
        params = {
            "expand": expand,
            "sort": sort,
            "limit": limit,
        ...
        if response.status_code == 200:
            return ZonePagedQueryResponse.deserialize(response.json())
