...
class PaymentAction(_BaseType):
    """Depending on the action specified, Checkout requests the [payment service provider](/../checkout/payment-connectors-applications#supported-psps-and-payment-methods) (PSP) to capture, refund, or cancel the authorization for the given Payment."""
